...
function Map() {
    ...
    const slug = searchParams.get('tag'); // Mengakses query parameter 'slug'
    ...
    return (
        <div className='section_info'>
                ...
                <div className='container'>
                    ...
                    <div className={`filter_map ${isFilterMapVisible ? 'active' : ''}`}>
                        {categories.map((category) => (
                            <Link href={{
                                pathname: '/festival-map',
                                query: {tag: category.slug},
                              }}
                              scroll={false}
                              passHref key={category.slug} className={`fm_box ${category.slug} ${category.name} ${activeCategory === category.slug ? 'active' : ''} ${filterBtnContent === category.name ? 'active' : ''}`}>
            ...
            <div className={`map_image ${maps.map_name.replace(/\s+/g, '')}`}>
