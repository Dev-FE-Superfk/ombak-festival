      ...
      <div className='container'>
        ...
        <div className='artist_detail'>
          <div className='detail_left'>
            <h3 className='mobile'>{visualarts.title}</h3>
            <Image
              src={visualarts.image_top}
              alt={visualarts.title}
              width={500}
              height={500}
            ></Image>
          </div>
          <div className='detail_right'>
            <div className='dr_info'>
              <h3 className='desktop'>{visualarts.title}</h3>
              {visualarts.description.map((desc, index) => (
