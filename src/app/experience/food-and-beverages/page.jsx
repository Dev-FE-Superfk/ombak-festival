...
export default function OmbakKids() {
  ...
  useEffect(() => {
    ...
    const apiUrl = process.env.NEXT_PUBLIC_API_URL + '/f-and-b';
    console.log(apiUrl);
    fetch(apiUrl, {
      method: 'GET',
      headers: {
  ...
  return (
    <div className='section_fnb'>
      <div className='fnb_banner'>
        <div className='fnb_image'>
          <Image
        ...
        <div className='fnb_info'>
          <div className='fnbi_box'>
                      ...
                      >
                        {contentData.items && contentData.items.length > 0 && (
                          <div className='festival_item_content'>
                            <Link href={`/experience/food-and-beverages/${contentData.items[0].v_page_element_slug}`}>
                            <div
